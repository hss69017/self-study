...
# font
game_font = pygame.font.Font(None, 40) # 'None': default

# 게임 제한 시간
total_time = 10

# info of starting time
...
while running:
    ...
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 # 단위가 ms이기 때문에 '/ 1000'

    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255, 255, 255)) # the word I want to print, True, color of the word
...
# delay
pygame.time.delay(2000) # 2sec waiting
