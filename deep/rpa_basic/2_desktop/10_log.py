...
# 시간 [로그레벨] 메시지
# # level: ~ 이상 되는 모든 로그 기록, format: 포맷
...
# 파일
filename = datetime.now().strftime("/Users/gunju/Desktop/self study/python/deep/rpa_basic/2_desktop/mylogfile_%Y%m%d%H%M%S.log")
